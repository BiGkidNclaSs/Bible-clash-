---
description: Show a scannable QR code for opening Bible Clash on an Android device
...
from the Play Store: scan the code with the Camera app or Google Lens and open the
link. If the user wants a home screen icon, tell them to use Chrome's ⋮ menu →
Add to Home screen.
